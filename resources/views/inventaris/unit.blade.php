        ...
        <table id="dataTable" class="table table-bordered table-striped align-middle">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $item->barangDetail->kode_barang }}</td>
                    <td>{{ $item->barangDetail->nama_barang }}</td>
                    <td>{{ $item->barangDetail->jenis_barang }}</td>
                    <td>{{ $item->barangDetail->merk_barang }}</td>
                    <td>20</td>
                    {{-- <td>
                    ...
                    <td>
                        <a type="button" data-bs-toggle="modal" data-bs-target="#ImageModal{{ $loop->iteration }}">
                            <img src="{{ asset($item->barangDetail->gambar_barang) }}" alt="image"
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <img src="{{ asset($item->barangDetail->gambar_barang) }}" class="d-block w-100"
                                            alt="img-3">
                                    </div>
