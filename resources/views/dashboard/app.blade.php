<x-layout>
    ...
    <div class="col-12 col-md-4 mb-3">
        <div class="card h-100">
            <div class="card-body overflow-hidden position-relative">
                ...
                <p class="text-muted">Total Barang Saat Ini</p>
    ...
    <!-- Barang Masuk Tahun Ini -->
    <div class="col-12 col-md-4 mb-3">
        <div class="card h-100">
            <div class="card-body overflow-hidden position-relative">
                <iconify-icon icon="mdi:tray-arrow-down" class="fs-36 text-primary"></iconify-icon>
                <h3 class="mb-0 fw-bold mt-3 mb-1">{{ $barangMasukThisYear }}</h3>
                <p class="text-muted">Barang Masuk (Thn {{ $tahunSekarang }})</p>
